...
let e = config.colors.axisColor;
let r = config.colors.borderColor;
...
export const totalRevenueChartOptions = {
  ...
  export const profileReportChartOptions = {
    chart: {
        height: 80,
        type: "line",
        toolbar: { show: !1 },
  ...
  export const orderStatisticsChartOptions = {
  ...
  export const expensesOfWeekChartOptions = {
    series: [65],
